            ...
            <div class="col-4 p-3">
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <a href="{{route('beneficiario.index')}}" class="card-link">CADASTRAR</a>
                    </div>
                </div>
            </div>
            <div class="col-4 p-3">
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <a href="{{route('medico.index')}}" class="card-link">CADASTRAR</a>
                    </div>
                </div>
            </div>
            <div class="col-4 p-3">
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <a href="{{route('especialidade.index')}}" class="card-link">CADASTRAR</a>
                    </div>
                </div>
            </div>
            <div class="col-4 p-3">
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <a href="{{route('local.index')}}" class="card-link">CADASTRAR</a>
                    </div>
                </div>
            </div>
            <div class="col-4 p-3">
                <div class="card w-100">
                    <div class="card-body">
                        ...
                        <a href="{{route('atendimento.index')}}" class="card-link">CADASTRAR</a>
                    </div>
                </div>
            </div>
        </div>
